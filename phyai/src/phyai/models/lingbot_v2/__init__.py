...
_LAZY_EXPORTS = {
    ...
    "LingBotV2Request": "scheduler_lingbotv2",
    "LingBotV2WS1Scheduler": "scheduler_lingbotv2",
    "build_action_paged_kv_indices": "scheduler_lingbotv2",
    "build_prefix_padded_write_indices": "scheduler_lingbotv2",
    "build_state_paged_kv_indices": "scheduler_lingbotv2",
    "build_suffix_mrope_position_ids": "scheduler_lingbotv2",
