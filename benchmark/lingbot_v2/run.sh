...
GPU=0
VISION_DTYPE="bf16"
# Match the released PatchEmbed operator unless a target explicitly needs GEMM.
...
released operator; select GEMM explicitly when Conv3D is unavailable or slow.
